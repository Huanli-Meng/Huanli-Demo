...
The following example shows how a Pulsar Go client provides a `ProducerMessage` interface to construct messages to a producer on Pulsar topics.
...
Here is another example of a producer.
